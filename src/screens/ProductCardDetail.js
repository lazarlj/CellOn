...
class ProductCardDetail extends Component {
  ...
  orderProduct = () => {
    const { navigation, user, orderProduct } = this.props;
  ...
  render() {
    ...
    const { data } = navigation.state.params;
    const { counter, tabIndex } = this.state;
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", marginHorizontal: 10 }}>
              <TouchableOpacity
                ...
                style={{
                  ...
                  flex: 1,
                  paddingBottom: 10,
                  borderBottomWidth: tabIndex === 0 ? 2.5 : 2.5,
                  borderBottomColor:
                    tabIndex === 0 ? colors.primaryColor : "transparent",
                }}
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  flex: 1,
                  paddingBottom: 10,
                  borderBottomWidth: tabIndex === 1 ? 2.5 : 2.5,
                  borderBottomColor:
                    tabIndex === 1 ? colors.primaryColor : "transparent",
                }}
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  flex: 1,
                  paddingBottom: 10,
                  borderBottomWidth: tabIndex === 2 ? 2.5 : 2.5,
                  borderBottomColor:
                    tabIndex === 2 ? colors.primaryColor : "transparent",
                }}
          ...
          <View style={styles.productDetailContainer}>
            ...
            >
              ...
              >
                {tabIndex === 0 && data.description}
                {tabIndex === 1 && data.detailes}
                {tabIndex === 2 && data.reviews}
              </Text>
              <BigButton
                onPress={() => {
                  this.orderProduct();
